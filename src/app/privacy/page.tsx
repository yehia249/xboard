    ...
    <>
      ...
      <p className="text-sm text-gray-400 mb-8">Last updated: {LAST_UPDATED}</p>
        ...
        <p className="text-gray-300 mb-6">
          This Privacy Policy explains how <strong>XBoard</strong> we handle your information when you use our platform (“the Service”). By using XBoard, you agree to this Policy. It’s meant to give you a plain-language overview of what happens to your data while you interact with the site, so you can understand the basics without having to read anything extra. If anything feels unclear, the intention is simply to restate the same idea in a more relaxed, straightforward way so you know what to expect as you continue using the Service.
        </p>

        <h2 className="text-2xl font-bold mb-3">Information Collected</h2>
        <p className="text-gray-300 mb-6 leading-7">
          We collect basic account details like your username, email, or content you create (for example, community listings). Payment processors may collect limited technical details necessary for secure transactions. In short, the information involved is the typical set you provide when creating an account and posting content, along with the minimal technical pieces required for things to work properly. The idea here is that what’s used is what’s needed for sign-in, listing, and payment to function, and not anything beyond that scope.
        </p>

        <h2 className="text-2xl font-bold mb-3">Information Usage</h2>
        <p className="text-gray-300 mb-6 leading-7">
          We use this information to operate and improve XBoard, process payments, prevent fraud or abuse, and send essential updates about the Service. Put simply, the information enables your account to work as expected, helps keep the platform reliable, and allows us to communicate necessary notices when something important changes. The goal is smooth operation and routine maintenance, so things continue running in a stable and predictable way.
        </p>

        <h2 className="text-2xl font-bold mb-3">Sharing Information</h2>
        <p className="text-gray-300 mb-6 leading-7">
          We work with third-party providers for authentication, hosting, and payment processing. These services operate under confidentiality obligations. We do not sell or rent your personal information. Any sharing is limited to what’s needed for the features you actively use, and it’s tied to providing the core functionality of the Service. The focus is simply on making sure the necessary pieces connect so your account and payments can function normally.
        </p>

        <h2 className="text-2xl font-bold mb-3">Cookies</h2>
        <p className="text-gray-300 mb-6 leading-7">
          We use cookies and local storage to keep you signed in and remember your preferences. You can disable cookies in your browser settings, but some parts of the site may not work correctly. These small files help the site remember simple things between visits, which keeps routine actions consistent. If you turn them off, the experience can still work in a basic way, but certain conveniences may no longer behave as you’d expect.
        </p>

        <h2 className="text-2xl font-bold mb-3">Data Security</h2>
        <p className="text-gray-300 mb-6 leading-7">
          We use industry-standard safeguards such as HTTPS and encryption to protect your data. While we strive to keep your information safe, no system is entirely secure. The intention is to apply common, well-understood protections that are widely used across the web so your typical actions—like signing in or updating a listing—happen over protected connections. Even so, it’s realistic to acknowledge that absolute security isn’t something any online service can promise.
        </p>

        <h2 className="text-2xl font-bold mb-3">Data Retention</h2>
        <p className="text-gray-300 mb-6 leading-7">
          Data is stored only as long as necessary to operate the Service and comply with legal obligations. Some data may remain in backups for a short period. The practical idea is that routine information lives as long as it’s needed for normal use, and then rolls off in due course, with backups clearing out on their own schedule. This is a simple, functional approach so the Service can continue to run without keeping more than it reasonably needs.
        </p>

        <h2 className="text-2xl font-bold mb-3">Your Rights</h2>
        <p className="text-gray-300 mb-6 leading-7">
          Depending on your location, you may request access, update, or deletion of your personal data through our platform. We will respond within a reasonable timeframe. In practice, this means you can reach out through the usual paths and expect a normal, timely follow-up that aligns with the process already described. The emphasis is on straightforward handling so you can manage your information in a simple, predictable way.
        </p>

        <h2 className="text-2xl font-bold mb-3">Children</h2>
        <p className="text-gray-300 mb-6 leading-7">
          XBoard is not intended for users under 13. We do not knowingly collect data from minors. If we learn that we have done so, we will delete such data promptly. This line is included to make the boundary clear, so there’s no confusion about who the Service is meant for and how any accidental submissions would be handled.
        </p>

        <h2 className="text-2xl font-bold mb-3">Changes</h2>
        <p className="text-gray-300 mb-6 leading-7">
          We may update this Privacy Policy from time to time. Continued use of the Service means you accept the updated version. If something changes, the main point is that the document will be refreshed to reflect the same ideas in a slightly updated form, and using the platform afterward indicates you’re proceeding under that updated text.
        </p>
      </main>

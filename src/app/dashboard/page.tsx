...
const SUGGESTED_TAGS: string[] = [
  ...
  "Tech","Sports","Celebrities","AI","Finance","Art","Animals","Anime","NSFW",
...
const XCommunityForm: React.FC<{
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 👇 force full page refresh so the user sees the community they just added
...
function DashboardContent() {
  ...
  const fetchUserDetails = async () => {
    try {
      ...
      if (res.ok) {
        ...
        // this already cuts out "@gmail.com" → we keep it
  ...
  // fallback if userName is empty for some reason
  ...
  />
      ...
      {/* HERE: change "Dashboard" → "Welcome, <user>" and cut the email domain */}
        ...
        <div style={{ display: "flex", gap: 6 }}>
          <button
            ...
            style={{
              ...
              background: 
                activeTab === "post" ? "rgba(56,97,251,0.08)" : "transparent",
              boxShadow:
                activeTab === "post"
                  ? "inset 0 -2px 0 #3861fb"
                  : "inset 0 -1px 0 #1b1f2a",
              color: activeTab === "post" ? "white" : "white",
              cursor: "pointer",
              fontWeight: 600,
          ...
          <button
            ...
            style={{
              ...
              border: "1px solid #151923",
              background:
                activeTab === "upgrade" ? "rgba(56,97,251,0.08)" : "transparent",
              boxShadow:
                activeTab === "upgrade"
                  ? "inset 0 -2px 0 #3861fb"
                  : "inset 0 -1px 0 #1b1f2a",
              color: activeTab === "upgrade" ? "white" : "white",
              cursor: "pointer",
              fontWeight: 600,
              transition: "all 160ms ease",
            }}
      ...
      {activeTab === "upgrade" && (
        ...
        >
          ...
          {upgradeQuery.trim().length === 0 ? (
            <div style={{ color: "#8b96a8", fontSize: 15 }}>
                  ...
                  >
                    ...
                    >
                      <svg
                        ...
                        height="20"
                        aria-hidden="true"
                        style={{ display: "block", flex: "0 0 auto", transform: "rotate(45deg)" }}
                      >
                    ...
                    <button
                      onClick={async () => {
                        ...
                        try {
                          ...
                          setUpgradeVisible((v) => v + more.length);
      ...
      <div className="communities-section">
        <div style={{ textAlign: "center", margin: "20px 0" , marginTop: "-1.35rem"}}>

    ...
    <>
      <div className="community-page">
        ...
        >
          ...
          >
            {/* (logo area intentionally left empty to match your original file) */}
             {/* Logo SVG */}
  <div
  ...
  />
      ...
      <main className="mx-auto max-w-4xl px-6 sm:px-8 py-12 sm:py-16 text-white">
        ...
        <p className="text-gray-300 leading-8 mb-12">
          This FAQ explains how <strong>XBoard</strong> works: listings, promotions, boosts, tiers, the
          dashboard, and the ranking algorithm. It reflects the current behavior of the platform and may
          evolve as features improve.
        </p>
        ...
        <div className="space-y-12">
              ...
              <table className="w-full text-left text-gray-300 text-sm border-separate border-spacing-y-1">
                ...
                <tbody className="align-top">
                  <tr className="bg-black/20">
                    ...
                    <td className="py-3 px-4">4 hour promotion cooldown and standard visibility.</td>
                  </tr>
          ...
          <section className="space-y-4">
            ...
            <p className="text-gray-300 leading-8">
              A <strong>boost</strong>  promotes your community to a higher position in listings.
            </p>
            <ul className="list-disc pl-6 text-gray-300 leading-8 space-y-2">
              <li>
                <strong>Unlimited boosts:</strong> Users can boost <em>without a daily cap</em>. To preserve fairness,
                there is a <strong>1-hour personal cooldown</strong> after using a boost (applies account-wide).
              </li>
              <li>
                <strong>Tier-based cooldowns (per community):</strong> Normal <strong>4h</strong>, Silver <strong>2h</strong>,
                Gold <strong>1h</strong>.
              </li>
              <li>
          ...
          <section className="space-y-6">
            <h2 className="text-2xl font-bold">5. Boost rules & cooldowns</h2>


            {/* Per-user card */}
            <div className="rounded-xl border border-gray-800/70 bg-black/30 backdrop-blur-sm p-5 sm:p-6">
              <h3 className="text-lg font-semibold mb-2">Per-User (Account-wide)</h3>
              <p className="text-gray-300 leading-8">
                <strong>Unlimited boosts</strong> with a <strong>1-hour personal cooldown</strong> after each boost.
              </p>
            </div>

            {/* Per-community table */}
            <div className="space-y-3">
              <h3 className="text-lg font-semibold">Per-Community Cooldown (by Tier)</h3>
              <div className="overflow-x-auto rounded-xl border border-gray-800/70 bg-black/30 backdrop-blur-sm">
                <table className="w-full text-left text-gray-300 text-sm border-separate border-spacing-y-1">
                  <thead className="text-gray-400">
                    <tr>
                      <th className="py-3 px-4">Tier</th>
                      <th className="py-3 px-4">Cooldown per Community</th>
                    </tr>
                  </thead>
                  <tbody className="align-top">
                    <tr className="bg-black/20">
              ...
              <p className="text-gray-300 leading-8">
                <strong>Notes:</strong> (1) Your personal cooldown applies to your account after any boost. (2) Each
                community also observes the tier-based cooldown above. You’ll be able to boost again once both the
                <em>personal</em> and the <em>community</em> cooldowns are satisfied. (3) Monthly promotion totals reset to 0
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc pl-6 text-gray-300 leading-8 space-y-2">
              <li>
                <strong>Boosts:</strong> Lift a listing towards the top.
              </li>
              <li>

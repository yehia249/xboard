...
const LAST_UPDATED = "October 16, 2025";
...
export default function FAQPage() {
  ...
  // Sticky header behavior (same pattern as other pages)
  useEffect(() => {
  ...
  />
      ...
      {/* MAIN */}
      <main className="mx-auto max-w-4xl px-6 sm:px-8 py-12 sm:py-16 text-white">
        {/* Page header */}
        <div className="mb-10 sm:mb-12">
          <h1 className="text-3xl sm:text-4xl font-extrabold mb-3">XBoard – FAQ</h1>
          <p className="text-sm text-gray-400">Last updated: {LAST_UPDATED}</p>
        </div>

        {/* Intro */}
        <p className="text-gray-300 leading-8 mb-12">
          This FAQ explains how <strong>XBoard</strong> works: listings, promotions, boosts, tiers, the dashboard, and the
          ranking algorithm. It reflects the current behavior of the platform and may evolve as features improve.
        </p>

        {/* Sections wrapper adds consistent breathing room */}
        <div className="space-y-12">
          {/* 1 */}
          <section className="space-y-4">
            <h2 className="text-2xl font-bold">1. What is XBoard?</h2>
            <p className="text-gray-300 leading-8">
              XBoard is a discovery and promotion hub for X (formerly Twitter) communities. Creators can list their
              communities, manage them from a personal dashboard, and use boosts or tier upgrades to improve visibility to
              potential members.
            </p>
          </section>
          ...
          {/* 2 */}
          <section className="space-y-4">
            <h2 className="text-2xl font-bold">2. How do I post my community?</h2>
            <ol className="list-decimal pl-6 text-gray-300 leading-8 space-y-2">
              <li>Sign up or log in.</li>
              <li>
                Open your <strong>Dashboard</strong>.
              </li>
              <li>
                Click <strong>&quot;Post Community&quot;</strong> and paste your X community link.
              </li>
              <li>Add tags and a description.</li>
              <li>Save. Your listing becomes publicly visible on the main page.</li>
            </ol>
          </section>

          {/* 3 */}
          <section className="space-y-5">
            <h2 className="text-2xl font-bold">3. What are tiers and what do they do?</h2>
            <p className="text-gray-300 leading-8">
              Tiers determine exposure and limits. You can upgrade anytime from your community page or the Dashboard.
            </p>

            <div className="overflow-x-auto rounded-xl border border-gray-800/70 bg-black/30 backdrop-blur-sm">
              <table className="w-full text-left text-gray-300 text-sm border-separate border-spacing-y-1">
                ...
                <tbody className="align-top">
                  <tr className="bg-black/20">
                    <td className="py-3 px-4 font-semibold">Normal</td>
                    <td className="py-3 px-4">Default tier for all listings.</td>
                    <td className="py-3 px-4">Standard visibility, eligible for daily boosts.</td>
                  </tr>
                  <tr className="bg-black/10">
                    <td className="py-3 px-4 font-semibold">Silver</td>
                    <td className="py-3 px-4">Premium visibility tier.</td>
                    <td className="py-3 px-4">Higher ranking weight and improved discoverability.</td>
                  </tr>
                  <tr className="bg-black/20">
                    <td className="py-3 px-4 font-semibold">Gold</td>
                    <td className="py-3 px-4">Top-tier promotion.</td>
                    <td className="py-3 px-4">Priority placement and maximum exposure benefits.</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          {/* 4 */}
          <section className="space-y-4">
            <h2 className="text-2xl font-bold">4. How do promotions and boosts work?</h2>
            <p className="text-gray-300 leading-8">
              A <strong>boost</strong> temporarily promotes your community to a higher position in listings. After the boost
              window, the listing returns to its natural position.
            </p>
            <ul className="list-disc pl-6 text-gray-300 leading-8 space-y-2">
              <li>
                <strong>Daily reset:</strong> Boost allowances reset every day at local midnight.
              </li>
              <li>
                <strong>Monthly reset:</strong>{" "}
                <em>All community promotion counters reset to 0 at the end of each month.</em>
              </li>
              <li>
                <strong>Fairness:</strong> Limits prevent spam and ensure rotation in top spots.
              </li>
            </ul>
          </section>
          ...
          <section className="space-y-6">
            <h2 className="text-2xl font-bold">5. What are daily boost limits?</h2>
            <p className="text-gray-300 leading-8">
              There are two limits: <strong>per-user</strong> and <strong>per-community (by tier)</strong>.
            </p>

            {/* Per-user card */}
            <div className="rounded-xl border border-gray-800/70 bg-black/30 backdrop-blur-sm p-5 sm:p-6">
              <h3 className="text-lg font-semibold mb-2">Per-User Daily Boosts</h3>
              <p className="text-gray-300 leading-8">
                Each user receives <strong>4 boosts per day</strong> to spend across the communities they own.
              </p>
            </div>

            {/* Per-community table */}
            <div className="space-y-3">
              <h3 className="text-lg font-semibold">Per-Community Daily Cap (by Tier)</h3>
              <div className="overflow-x-auto rounded-xl border border-gray-800/70 bg-black/30 backdrop-blur-sm">
                <table className="w-full text-left text-gray-300 text-sm border-separate border-spacing-y-1">
                  <thead className="text-gray-400">
                    <tr>
                      <th className="py-3 px-4">Tier</th>
                      <th className="py-3 px-4">Daily Boost Cap (per community)</th>
                  ...
                  <tbody className="align-top">
                    <tr className="bg-black/20">
                      <td className="py-3 px-4 font-semibold">Normal</td>
                      <td className="py-3 px-4">1 time per day</td>
                      <td className="py-3 px-4">24 Hours</td>
                    </tr>
                    <tr className="bg-black/10">
                      <td className="py-3 px-4 font-semibold">Silver</td>
                      <td className="py-3 px-4">2 times per day</td>
                      <td className="py-3 px-4">12 Hours</td>
                    </tr>
                    <tr className="bg-black/20">
                      <td className="py-3 px-4 font-semibold">Gold</td>
                      <td className="py-3 px-4">4 times per day</td>
              ...
              <p className="text-gray-300 leading-8">
                <strong>Notes:</strong> (1) Your <em>personal</em> allowance is <strong>4 boosts/day</strong>. (2) Each community
                you own also has its <em>own</em> tier-based daily cap as listed above. (3) Daily allowances reset at local
                midnight. (4) <strong>Monthly promotion totals</strong> (the count of boosts/promotions made by a community){" "}
                <strong>reset to 0 at the end of each month</strong> to ensure a fresh, fair cycle.
              </p>
            </div>
          </section>
          ...
          {/* 6 */}
          <section className="space-y-4">
            <h2 className="text-2xl font-bold">6. How does the ranking algorithm work?</h2>
            <ul className="list-disc pl-6 text-gray-300 leading-8 space-y-2">
              <li>
                <strong>Recent boosts:</strong> Temporarily lift a listing toward the top.
              </li>
              <li>
                <strong>Tier weight:</strong> Silver and Gold receive a modest ranking bonus.
              </li>
              <li>
                <strong>Engagement:</strong> Clicks, joins, and interactions can gradually improve visibility.
              </li>
              <li>
                <strong>Rotation:</strong> Prevents a single listing from remaining pinned indefinitely.
              </li>
              <li>
                <strong>Monthly reset:</strong> Promotion counters return to 0 at month’s end for equal opportunity.
              </li>
            </ul>
          </section>
          ...
          {/* 7 */}
          <section className="space-y-4">
            <h2 className="text-2xl font-bold">7. What can I do in the Dashboard?</h2>
            <ul className="list-disc pl-6 text-gray-300 leading-8 space-y-2">
              <li>View and manage all your communities.</li>
              <li>Edit or delete listings at any time.</li>
              <li>See your tier, personal remaining boosts, and each community’s daily cap status.</li>
              <li>Trigger boosts and upgrade tiers.</li>
              <li>Track performance metrics (if available on your account).</li>
            </ul>
          </section>
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc pl-6 text-gray-300 leading-8 space-y-2">
              ...
              <li>Use Silver/Gold when launching or running campaigns.</li>
              <li>Encourage engagement—active communities trend better over time.</li>
            </ul>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className="text-gray-300 leading-8">
              Yes. Personal daily limits, per-community caps, and monthly resets are designed to preserve fairness.
            </p>
          </section>
          ...
          {/* 14 */}
          <section className="space-y-4">
            <h2 className="text-2xl font-bold">14. Support</h2>
            <p className="text-gray-300 leading-8">
              For help with listings, boosts, or payments, contact us through the support options provided in the app.
            </p>
          </section>
        </div>
      </main>

...
function SignupForm() {
  ...
  // We'll set this in the parent component from URL params
  const [redirectUrl, setRedirectUrl] = useState('/dashboard');
  
  React.useEffect(() => {
    // Get redirect URL from localStorage (set by parent component)
...
// Separate component that gets the URL params and sets up the redirect
function SignupParamsHandler() {
  ...
  React.useEffect(() => {
    ...
    // Store in localStorage for the form component to use

...
export default function TermsPage() {
  ...
  />
            {/* logo / brand area (intentionally unchanged) */}
          </Link>
      ...
      <main className="max-w-3xl mx-auto px-6 py-16 text-white">
        ...
        <p className="text-gray-300 mb-6 leading-7">
          These Terms of Service (&quot;<strong>Terms</strong>&quot;) govern your access to and use of the XBoard website, products, and services (collectively, the &quot;<strong>Service</strong>&quot;). By accessing or using the Service, you agree to be bound by these Terms and our Privacy Policy. If you do not agree, do not use the Service.
        </p>

        <h2 className="text-2xl font-bold mb-3">1. Eligibility and Account Responsibility</h2>
        <p className="text-gray-300 mb-6 leading-7">
          You must be able to form a legally binding contract under applicable law to use the Service. You are responsible for safeguarding your credentials and for all activity conducted under your account. We may suspend or terminate your account if we believe, in our reasonable discretion, that you have violated these Terms or engaged in fraudulent, unlawful, or abusive activity.
        </p>

        <h2 className="text-2xl font-bold mb-3">2. User Content and License</h2>
        <p className="text-gray-300 mb-6 leading-7">
          You may submit listings, media, text, and other materials (&quot;<strong>User Content</strong>&quot;). You represent and warrant that you own or have obtained all rights necessary to submit the User Content and to grant the rights described here. You grant XBoard a non-exclusive, worldwide, royalty-free license to host, display, and distribute your User Content solely to operate and improve the Service. We may remove or disable access to any User Content that we reasonably believe violates law, rights of others, or these Terms.
        </p>

        <h2 className="text-2xl font-bold mb-3">3. Payments, Subscriptions, and Billing</h2>
        <p className="text-gray-300 mb-6 leading-7">
          Certain features may be offered on a paid basis, including recurring subscriptions. Payments are processed by third-party providers. Features become available upon payment confirmation. Pricing, renewal, cancellation, and refund terms are set forth by the checkout provider and/or presented at the point of purchase and are incorporated by reference. You authorize us and our payment partners to charge your selected payment method according to those terms.
        </p>

        <h2 className="text-2xl font-bold mb-3">4. Intellectual Property</h2>
        <p className="text-gray-300 mb-6 leading-7">
          The Service, including its software, design, logos, and trademarks, is owned by or licensed to XBoard and is protected by intellectual property laws. Except as expressly permitted by these Terms, you may not copy, modify, distribute, sell, lease, or create derivative works from any part of the Service without our prior written consent.
        </p>

        <h2 className="text-2xl font-bold mb-3">5. Prohibited Activities</h2>
        <p className="text-gray-300 mb-6 leading-7">
          You may not: (a) use the Service for unlawful, fraudulent, or abusive purposes; (b) interfere with or disrupt the Service or other users’ access; (c) circumvent or attempt to circumvent security or access controls; (d) post or promote content that infringes rights, constitutes spam, or manipulates listings; or (e) misuse payment flows or dispute processes.
        </p>

        <h2 className="text-2xl font-bold mb-3">6. Third-Party Services</h2>
        <p className="text-gray-300 mb-6 leading-7">
          The Service may integrate or link to third-party services (e.g., authentication, hosting, payment). We are not responsible for third-party services and disclaim liability arising from your use of them. Your use of third-party services is governed by their terms and policies.
        </p>

        <h2 className="text-2xl font-bold mb-3">7. Disclaimers</h2>
        <p className="text-gray-300 mb-6 leading-7">
        ...
        <p className="text-gray-300 mb-6 leading-7">
          TO THE MAXIMUM EXTENT PERMITTED BY LAW, XBOARD AND ITS AFFILIATES, OFFICERS, EMPLOYEES, AND AGENTS WILL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, EXEMPLARY, OR PUNITIVE DAMAGES, OR ANY LOSS OF PROFITS, REVENUE, DATA, OR GOODWILL, ARISING OUT OF OR RELATED TO YOUR USE OF THE SERVICE, EVEN IF ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
        </p>

        <h2 className="text-2xl font-bold mb-3">9. Indemnification</h2>
        <p className="text-gray-300 mb-6 leading-7">
          You agree to defend, indemnify, and hold harmless XBoard and its affiliates, officers, employees, and agents from and against any claims, liabilities, damages, losses, and expenses (including reasonable attorneys’ fees) arising out of or related to your User Content, your use of the Service, or your violation of these Terms or applicable law.
        </p>

        <h2 className="text-2xl font-bold mb-3">10. Termination</h2>
        <p className="text-gray-300 mb-6 leading-7">
          We may suspend or terminate access to the Service at any time with or without notice if we reasonably believe you have violated these Terms or pose a risk to the Service or other users. Upon termination, the rights and licenses granted to you will cease, except that Sections 4, 7–12 survive termination.
        </p>

        <h2 className="text-2xl font-bold mb-3">11. Changes to the Terms</h2>
        <p className="text-gray-300 mb-6 leading-7">
          We may update these Terms from time to time. The &quot;Last updated&quot; date reflects the effective date. Your continued use of the Service after changes become effective constitutes acceptance of the updated Terms.
        </p>

        <h2 className="text-2xl font-bold mb-3">12. Governing Law</h2>
        <p className="text-gray-300 mb-6 leading-7">
          These Terms are governed by the laws applicable in your place of residence unless mandatory law requires otherwise. Any disputes will be subject to the exclusive jurisdiction of the courts having such authority under applicable law.
        </p>

        <h2 className="text-2xl font-bold mb-3">13. Contact</h2>
        <p className="text-gray-300 mb-6 leading-7">
          If you have questions about these Terms, please contact us using the channels provided on the Service.
        </p>
      </main>

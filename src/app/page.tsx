...
export default function CommunityPage() {
  ...
  return (
    <div className="community-page" style={{ position: "relative", width: "100%", margin: 0, padding: 0 }}>
      {/*
        1) Sticky Header
           Uses a <header> element with sticky positioning so it always stays at the top.
      */}
      <header
        style={{
          position: "sticky",
      ...
      {/*
        2) Navigation Container
           Positioned relatively underneath the header.
      */}
      <div
      ...
      >
        {!user ? (
          ...
          <>
            <Link href="/dashboard">
              <button className="logabutton" style={{ zIndex: 10 }}>
                <span>Dashboard</span>
              </button>
            </Link>
      ...
      {/*
        3) Main Content
           Adds a small padding at the top to ensure nothing is hidden behind the header.
      */}

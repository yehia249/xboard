          ...
          {!showPromoCard && (
            <button
              ...
              style={{
                ...
                placeItems: "center",
                cursor: "pointer",
                // ↑ ensure the circle sits ABOVE the edge tab so it's clickable
                zIndex: 10002,
                // make sure it receives clicks even if any ancestor had pointer-events none
                pointerEvents: "auto",
              }}
              role="button"
            >
          ...
          {!showPromoCard && (
            <div
              ...
              style={{
                ...
                fontSize: 13,
                cursor: "pointer",
                // keep this under the circle so it doesn't block clicks
                zIndex: 10001,
                border: "1px solid rgba(255,255,255,0.08)",
                borderBottom: "none",
                pointerEvents: "auto",

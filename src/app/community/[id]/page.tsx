...
const showSignupModal = () => {
  ...
  // Set return path in localStorage to be used after signup
  ...
  confirmButton.addEventListener('click', () => {
    ...
    // Navigate to signup page with return path in query parameter
    window.location.href = `/signup?returnTo=${encodeURIComponent(currentPath)}`;
    ...
    try {
      ...
      if (!token) {
        ...
        setTimeout(() => {
          ...
          showSignupModal();
        }, 1500); // Short delay after the toast appears

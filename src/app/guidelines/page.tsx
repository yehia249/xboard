...
export default function GuidelinesPage() {
  ...
  return (
    // Page wrapper: fills viewport and pushes Footer to the bottom
    <div
      style={{
        minHeight: "100dvh",
        display: "flex",
  ...
  />
      ...
      {/* Main grows to fill leftover space so Footer sits at the bottom */}
      <main
        className="max-w-3xl mx-auto px-6 py-16 text-white"
        style={{
          paddingLeft: isNarrow ? 30 : undefined, paddingRight: isNarrow ? 30 : undefined,
          flex: 1,
          width: "100%",
        }}
      >
      ...
      {/* Footer anchored by the flex layout */}
      <Footer />
    </div>
  );
}
